# Identify Providers (Google/Gitlab/etc)

OpenID providers can be configured by editing the apps.yml. Hovewer, we also need to update the logic to retrieve the idp account details. We use the idp email for linking pourposes.
